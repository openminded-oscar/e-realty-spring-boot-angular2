...
export class ReviewsService extends AbstractService <Review> {
  ...
  public get(userId: number, realtyObjId: number): Observable<HttpResponse<Review>>{
  ...
  public remove(userId: number, realtyObjId: number): Observable<HttpResponse<Review>>{
