...
export const supportedRegions = [
        ...
        { id: 4, name: 'Dnipro', lat: 48.6196, lng: 34.8044 },
        { id: 5, name: 'Lviv', lat: 49.8397, lng: 24.0297 },
        { id: 6, name: 'Vinnytsia', lat: 49.2328, lng: 28.4826 },
        { id: 7, name: 'Zhytomyr', lat: 50.6199, lng: 26.2516 },
        { id: 8, name: 'Chernivtsi', lat: 48.2908, lng: 26.5805 },
        ...
        { id: 13, name: 'Kropyvnytskyi', lat: 49.4444, lng: 31.9946 },
        { id: 14, name: 'Rivne', lat: 50.9077, lng: 30.1325 },
        { id: 15, name: 'Poltava', lat: 48.0196, lng: 35.0443 },
        { id: 16, name: 'Mykolaiv', lat: 46.9750, lng: 31.8906 },
        { id: 17, name: 'Khmelnytskyi', lat: 50.2579, lng: 27.6326 },
        { id: 18, name: 'Luhansk', lat: 48.8833, lng: 35.8497 },
